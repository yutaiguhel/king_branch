...
from Bayes_function10_1 import*
import numpy as np
...
m.V1=1.0 #ワイヤ1の電圧
m.t=0.05 #MWwidth
m.g=     {"V1":10,"V2":5,"phi":5,  "MWwidth":10, "MWfreq":10} #量子操作において変更するパラメータの分割数 V1,V2,phi,t,MW_freq
m.ParamC={"V1":1, "V2":0, "phi":0,  "MWwidth":1,  "MWfreq":1} #V1,V2,phi,MWwidth,MWfreq 変更する場合は1
m.RangeC={"V1":1, "V2":1, "phi":360,"MWwidth":0.08,"MWfreq":4} #実験設計パラメータの拡張範囲
#============================推定パラメータの変更==================================
m.a1=20
m.b1=1.0
m.Ac_list=[]#[-3.265]
#炭素数に応じてParamH,RangeHの数だけParamH,RangeHを増やす
m.n=     {"a1":10, "b1":10, "a2":5,  "b2":5,  "w_theta":10,     "D0":10,"AN":5,"QN":0,"Bz":0} #推定基底毎のパーティクルの数 a1,b1,a2,b2,w_theta,D0,An,Qn,Bz *Ac
m.ParamH={"a1":1,   "b1":1,  "a2":0,  "b2":0,  "w_theta":0,      "D0":1,"AN":0,"QN":0,"Bz":0} #a1,b1,a2,b2,w_theta,D0,AN,QN,外部磁場,*炭素 変更する場合は1
m.RangeH={"a1":30,  "b1":1,"a2":300,"b2":0.8,"w_theta":2*np.pi,"D0":3,"AN":0.05,"QN":0,"Bz":0} #推定パラメータの広げる範囲
