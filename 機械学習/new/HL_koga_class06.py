...
m.n={"a1":30,"b1":30,"a2":5,"b2":5,"w_theta":10,"D0":0,"AN":0,"QN":0,"Bz":0} #推定基底毎のパーティクルの数 a1,b1,a2,b2,w_theta,D0,An,Qn,Bz *Ac
m.g={"V1":100,"V2":10,"phi":0,"MWwidth":5,"MWfreq":5} #量子操作において変更するパラメータの分割数 V1,V2,phi,t,MW_freq
m.bayes_threshold=1
m.wire=1
#============================推定パラメータの変更==================================
m.a1=500
...
m.RangeH={"a1":900,"b1":0.9,"a2":300,"b2":0.8,"w_theta":2*np.pi,"D0":10,"AN":0,"QN":0,"Bz":0} #推定パラメータの広げる範囲
m.ParamC={"V1":1,"V2":0,"phi":0,"MWwidth":1,"MWfreq":1} #V1,V2,phi,MWwidth,MWfreq 変更する場合は1
m.RangeC={"V1":1,"V2":1,"phi":360,"MWwidth":0.05,"MWfreq":10} #実験設計パラメータの拡張範囲
