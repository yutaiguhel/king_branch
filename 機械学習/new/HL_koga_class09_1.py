...
from Bayes_function09_1 import*
import numpy as np
...
m.V1=0.5 #ワイヤ1の電圧
m.t=0.05 #MWwidth
m.g=     {"V1":100,"V2":10,"phi":5,  "MWwidth":10, "MWfreq":5} #量子操作において変更するパラメータの分割数 V1,V2,phi,t,MW_freq
m.ParamC={"V1":1, "V2":0, "phi":0,  "MWwidth":0,  "MWfreq":0} #V1,V2,phi,MWwidth,MWfreq 変更する場合は1
...
m.n=     {"a1":200, "b1":20, "a2":5,  "b2":5,  "w_theta":10,     "D0":100,"AN":0,"QN":0,"Bz":0} #推定基底毎のパーティクルの数 a1,b1,a2,b2,w_theta,D0,An,Qn,Bz *Ac
m.ParamH={"a1":1,   "b1":1,  "a2":0,  "b2":0,  "w_theta":0,      "D0":0, "AN":0,"QN":0,"Bz":0} #a1,b1,a2,b2,w_theta,D0,AN,QN,外部磁場,*炭素 変更する場合は1
m.RangeH={"a1":800, "b1":0.5,"a2":300,"b2":0.8,"w_theta":2*np.pi,"D0":3,"AN":0,"QN":0,"Bz":0} #推定パラメータの広げる範囲
...
for i in range(m.ex):
    ...
    #m.UtilIG_bayes_risk()　＃効用をbウィズリスクとする場合
