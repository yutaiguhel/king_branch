...
m.V1=1.5 #ワイヤ1の電圧
m.t=2.0 #MWwidth
m.g=     {"V1":60,"V2":10,"phi":10,  "MWwidth":60, "MWfreq":10} #量子操作において変更するパラメータの分割数 V1,V2,phi,t,MW_freq
...
m.n=     {"a1":20, "b1":20, "a2":10,  "b2":10,  "w_theta":10,     "D0":10,"AN":5,"QN":0,"Bz":0} #推定基底毎のパーティクルの数 a1,b1,a2,b2,w_theta,D0,An,Qn,Bz *Ac
