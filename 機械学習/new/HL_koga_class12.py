...
m.V1=1.25 #ワイヤ1の電圧
m.t =2.0 #MWwidth
m.g=     {"V1":50,"V2":10,"phi":10,  "MWwidth":50, "MWfreq":10} #量子操作において変更するパラメータの分割数 V1,V2,phi,t,MW_freq
m.ParamC={"V1":1, "V2":0, "phi":0,  "MWwidth":1,  "MWfreq":0} #V1,V2,phi,MWwidth,MWfreq 変更する場合は1
m.RangeC={"V1":2.49, "V2":1, "phi":360,"MWwidth":3.98,"MWfreq":4} #実験設計パラメータの拡張範囲
#============================推定パラメータの変更==================================
m.a1=20
m.b1=1.5
m.a2=15
...
m.RangeH={"a1":30, "b1":1.5,  "a2":20,"b2":0.8,"w_theta":2*np.pi,"D0":3,"AN":0.05,"QN":0,"Bz":0} #推定パラメータの広げる範囲
