...
class Bayes_Function(Q_H):
    ...
    def params(self):
        ...
        self.x_dict={"a1":self.a1+self.a1/10,"b1":self.b1-self.b1/20,"a2":self.a2-self.a2/10,"b2":self.b2+self.b2/5,"w_theta":self.w_theta
    ...
    def Expsim(self,x,C): #実験と同様のシーケンスを行いデータの生成を行う関数
        ...
        self.Vdrive_all(C[0],C[1],C[2]) #C[0]:V1, C[1]:V2, C[2]:ワイヤ間の位相差phi
        rhof=self.Tevo(C[3]) #MWwidth
