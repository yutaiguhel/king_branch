...
gf.t_div = 1000/1000.0
gf.frequency_grape = D0
gf.power_max = 1000/1/2.0
...
gf.params_Redefine()
gf.Hamiltonian_calc()
gf.pulse_shape = array([[1000/4990/2.0]])
gf.calc_fid_err(gf.H_params)
si = tensor(S0,III/3.0)
prj = tensor(SH,III/3.0)
U = gf.Uarb_last
print(fidelity(prj,U*si*U.dag()))
"""
fid_err = 1
count = 0
