...
class Grape_funcs_for_single_wire(Grape_funcs):   
    ...
    def calc_fid_err(self,params):
        ...
        if number_C_known != 0:
            ...
            Hdrift = H0-self.frequency_grape*Hdetuning
        CPO = cpo.create_pulse_optimizer(2*pi*Hdrift,[2*pi*self.Hdrive1],self.Uinit,self.U_goal,self.n_tslot,self.pulse_time,
                                   dyn_type='UNIT',
                                   dyn_params=None,
                                   prop_type='DEF',
                                   fid_type='DEF',
...
class Grape_funcs_for_cross_wire(Grape_funcs):   
    ...
    def calc_fid_err(self,params):
        ...
        if number_C_known != 0:
            ...
            Hdetuning = tensor(Szz,III)
            Hdrift = H0-self.frequency_grape*Hdetuning
        CPO = cpo.create_pulse_optimizer(2*pi*Hdrift,[2*pi*self.Hdrive1,2*pi*self.Hdrive2],self.Uinit,self.U_goal,self.n_tslot,self.pulse_time,
                                   dyn_type='UNIT',
                                   dyn_params=None,
                                   prop_type='DEF',
                                   fid_type='DEF',
