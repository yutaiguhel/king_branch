...
from Quantum_Parameter01 import*
from Q_module_new02 import*
import time
import path
start = time.time()

class GRAPE_Parameter(Quantum_Parameter):
    ...
    def __init__(self,D0,AN,QN,C_known,C_inhomo,Bz,theta,phi1,phi2,
    ...
    def physical_status(self):
        physical_param=[self.D0,self.AN,self.QN,self.C_known,self.C_inhomo,
